...
| [`branching_quests`](branching_quests/) | Two questlines with real choices and multiple endings (side with the scientist or the gambler; recover the shard or take the bribe), where NPCs react to the side you pick. |
